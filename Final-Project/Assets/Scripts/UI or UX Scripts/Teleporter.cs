    ...
    void Update()
    {
        ...
        if ( levelController.GetComponent<HasClearedLevelController>().GetTutorial() )
        {
                if ( SceneManager.GetActiveScene().name == "TutorialReal" )
                {
                    ...
                    Debug.Log("Powdery Peaks placeholder teleporter message, put in a transform.position here once you know where to spawn the teleporter");
                else if ( SceneManager.GetActiveScene().name == "Suspicious Sands")
                    Debug.Log("Suspicious Sands placeholder teleporter message, put in a transform.position here once you know where to spawn the teleporter");
        }
        else
