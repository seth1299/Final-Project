...
public class SimpleAIController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Physics.Raycast(gameObject.transform.position, gameObject.transform.forward, lookDist, LayerMask.GetMask("NPC and PC")
        //Debug.DrawRay(transform.position, transform.TransformDirection(Vector3.forward) * 10, Color.red, 2f, false);
