...
public class SettingsController : MonoBehaviour
{
    ...
    public Image infiniteHealthImage, infiniteManaImage, infiniteAmmoImage;
    ...
    void Start()
    {
        ...
        {
            if ( levelController.GetComponent<HasClearedLevelController>().GetPlayerInfiniteAmmo() )
            {
                infiniteAmmoImage.enabled = true;
            }
            else
            {
                infiniteAmmoImage.enabled = false;
            }

            if ( levelController.GetComponent<HasClearedLevelController>().GetPlayerInvincibility() )
            {
                infiniteHealthImage.enabled = true;
            }
            else
            {
                infiniteHealthImage.enabled = false;
            }

            if ( levelController.GetComponent<HasClearedLevelController>().GetPlayerInfiniteMana() )
            {
                infiniteManaImage.enabled = true;
            }
            else
            {
                infiniteManaImage.enabled = false;
            }
